  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center p-6">
        <div className="flex h-full flex-col gap-16 md:max-w-xl">
          <h1 className="flex justify-center font-extrabold tracking-tight">
            <Link href="/">
              <span className="text-4xl text-brand-purple">dewdayte</span>
            </Link>
          </h1>
